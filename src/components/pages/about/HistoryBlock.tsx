...
export const HistoryBlock: React.FC = () => {
    ...
    return (
        <Grid container direction={matchesMd ? "column" : "row"} justify={matchesMd ? "space-around" : undefined} alignItems={matchesMd ? "center" : undefined}>
            <Grid item>
                <Grid container direction="column" lg style={{maxWidth: "35em"}}>
                    ...
                    <Grid item>
                        <Typography variant="body1" paragraph className={classes.boldSubtitle}>
